...
\begin{center}
    \includegraphics[height=3.8in, width=3.8in]{plot2s22.jpg}  %Can use scale = 3 or some other value, in place of height and width
...
\begin{center}
\includegraphics[height=3.8in, width=3.8in]{plotp13s22.jpg}
...
\begin{center}
\includegraphics[height=3.8in, width=3.8in]{recipfcn.jpg}
...
each factor in the numerator and denominator as $x \rightarrow c.$   In some cases, you will need to consider two-sided limits. 
These can be tricky, so watch the video below. \\
...
\begin{problem} Use a limit, \textit{with proper notation}, to describe the behavior of the function $f(x)=\ln x$ as $x$ approaches $1.$
    ...
    \begin{center}
        \includegraphics[height=3.8in, width=3.8in]{lnplot.png}
        \xmalt{A graph showing the natural logarithmic function.  The graph lies only in quadrants 1 and 4, increases from left 
        to right and passes through the x axis at 1.  The graph approaches negative infinity as x approaches 0 from the right.}
    \end{center}
...
\begin{center}
\includegraphics[height=3.8in, width=3.8in]{sinrecip.jpg}
