...
\begin{problem}
Consider the definite integral from the previous problem.  Using the substitution, rewrite the integral completely in terms of 
$u,$ including changing the limits of integration. 
