...
containing a radical, use the sqrt( ) function.  For example, type sqrt(2) for $\sqrt{2}.$  To enter an answer containing 
$\infty,$ type infinity or oo (two lowercase letter o's).
