...
\begin{problem}
Evaluate the indefinite integral by first simplifying the integran, then use the power rule.

\[
\int \frac{x^3 - 5x + 6}{x^2} \, dx
\]

Rewrite the integrand by dividing each term by $x^2.$
...
\[
\int \frac{x^3 - 5x + 6}{x^2} \, dx = \answer{\frac{1}{2}x^2 - 5\ln|x| - \frac{6}{x}} + C
\]
\end{problem}
...
The final answer is:
\[
\int x^2 e^{x^3} \, dx = \answer{\frac{1}{3}e^{x^3}} + C
\]
\end{problem}
