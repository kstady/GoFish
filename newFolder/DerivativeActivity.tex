...
\xmalt{An interactive Desmos graph shows the function $f(x) = e^x.$ A fixed point $P$ is marked near $x = 1,$ and a movable point $Q$ is
...
and $Q.$ As the user drags point $Q$ toward $P,$ $\Delta x \rightarrow 0$ and the orange secant line becomes the blue tangent line.}
