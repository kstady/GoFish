...
containing a radical, use the sqrt( ) function.  For example, type sqrt(2) for $\sqrt{2}.$  To enter an answer containing $\infty,$ type infinity or oo.
...
\begin{hint}
\textbf{Use the properties of limits to rewrite the limit as a product of limits that you can evaluate.  See the Evaluating Limits Analytically on the previous page}
\end{hint}
